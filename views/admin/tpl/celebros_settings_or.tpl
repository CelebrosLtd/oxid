...
<form name="transfer" id="transfer" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <input type="hidden" name="cl" value="celebros_settings">
...
<form name="myedit" id="myedit" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <div class="groupExp">
        <div id="liste">
            <a href="#" onclick="_groupExp(this);
          return false;" class="rc"><b>[{oxmultilang ident="cel_SHOP_OPTIONS_GROUP_SALESPERSON_MAPPINGS"}]</b></a>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);
          return false;" class="rc"><b>[{oxmultilang ident="cel_SHOP_OPTIONS_GROUP_SALESPERSON_ANALYTICS"}]</b></a>
          <dl>
                <dt>
    ...
    <div class="groupExp">
        <div>
            <a href="#" onclick="_groupExp(this);
          return false;" class="rc"><b>[{oxmultilang ident="cel_SHOP_OPTIONS_GROUP_SALESPERSON_FTP"}]</b></a>
            <dl>
                <dt>
