...
$aLang = array(
    ...
    'celebros_synchro' => 'Celebros Synchro',
    ...
    'cel_salesperson_menuitem' => 'Shop Settings',
    'cel_salesperson_menusubitem' => 'Salesperson',
    ...
    'EMAIL_PRICEALARM_CUSTOMER_ITEM2' => 'f�r den Sie sich interessieren und einen Preis von',
    'EMAIL_PRICEALARM_CUSTOMER_ITEM3' => 'geboten haben ist jetzt f�r',
...
// cel_salesperson backend module
    'celebros_settings' => 'Celebros Einstellungen',
    'cel_salesperson_menuitem' => 'Shop Settings', 'cel_salesperson_menusubitem' => 'Salesperson',
    'cel_SHOP_OPTIONS_GROUP_SALESPERSON_CONNECTION_SETTINGS' => 'Search Results Connection Settings',
    'cel_SHOP_SETTINGS_SALESPERSON_SERVICE_HOST' => 'Search Service Url',
    'cel_SHOP_SETTINGS_SALESPERSON_SITE_KEY' => 'Site Key',
    'cel_SHOP_SETTINGS_SALESPERSON_CUSTOMER_NAME' => 'Customer Name',
    'cel_SHOP_OPTIONS_GROUP_SALESPERSON_MAPPINGS' => 'Data mapping',
    'cel_SHOP_SETTINGS_SALESPERSON_SORTING_FIELDS_MAPPINGS' => 'Allowed Sorting Fields',
    ...
    'cel_SHOP_SETTINGS_SALESPERSON_NUMERIC_SORT' => 'Sort Numerically by Default',
    'cel_SHOP_SETTINGS_SALESPERSON_NUMERIC_ASCENDING' => 'Sort Ascendingly by Default ',
    'cel_SHOP_SETTINGS_SALESPERSON_SEARCH_PROFILE' => 'Suchprofil', 
    'cel_SHOP_OPTIONS_GROUP_SALESPERSON_DISPLAY_SEARCH_RESULTS_SETTINGS' => 'Search Results Display Settings',
    'cel_SHOP_SETTINGS_SALESPERSON_MAX_NONE_LEAD_QUESTIONS' => 'Max Non Lead Questions',
    'cel_SHOP_SETTINGS_SALESPERSON_MAX_NONE_LEAD_ANSWERS' => 'Max Non Lead Answers',
    'cel_SHOP_SETTINGS_SALESPERSON_DISPLAY_LEAD_ANSWERS' => 'Display Full List of Lead Answers',
    ...
    'celebros_export' => 'Celebros Export',
    'celebros_synchro' => 'Daten synchronisieren',
    'cel_SHOP_OPTIONS_GROUP_SALESPERSON_SYNCHRO_SETTINGS' => 'Einstellungen Datensynchro.',
    'cel_SHOP_SETTINGS_SALESPERSON_SYNCHRO_TIMEINTERVAL' => 'Synchronisierungsintervall (in min.)',
    'cel_SHOP_SETTINGS_SALESPERSON_CATEGORY_SEARCH_SETTINGS' => 'Einstellungen Kategoriesuche',
    'cel_SHOP_SETTINGS_SALESPERSON_CATEGORY_SEARCH_SETTINGS_OFF' => 'Deaktiviert',
    'cel_SHOP_SETTINGS_SALESPERSON_CATEGORY_SEARCH_SETTINGS_CATEGORY' => 'Kategoriesuche',
    'cel_SHOP_SETTINGS_SALESPERSON_CATEGORY_SEARCH_SETTINGS_FULL_CATEGORY' => 'Vollkategoriesuche',
    'cel_SHOP_SETTINGS_SALESPERSON_CATEGORY_SEARCH_SETTINGS_CATEGORY_LEGEND' => 'Modus für Kategoriesuche',
    'cel_SHOP_OPTIONS_GROUP_SALESPERSON_LIVESIGHT_OPTIONS' => 'LiveSight Einstellungen',
    'cel_SHOP_SETTINGS_SALESPERSON_LIVESIGHT_ACTIVATE'  => 'LiveSight aktivieren',
    'cel_HELP_SHOP_SETTINGS_SALESPERSON_SEARCH_PROFILE' => 'Das ausgewählte Suchprofil. Beachten Sie die Dokumentation für mehr Informationen.',
    'cel_SHOP_SETTINGS_SALESPERSON_SERVICE_PORT'				=> 'Port',
    'cel_SHOP_SETTINGS_SALESPERSON_ANALYTICS_ACTIVATE' => 'Celebros Analytics aktivieren',
    'cel_RESET_MAPPING' => 'Mapping zur&uuml;cksetzen',
